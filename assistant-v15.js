...
(() => {
  ...
  const sources={
    dex:['NWN: Digital Employee Experience','https://nwn.ai/digital-employee-experience/'],
  ...
  add('partners','Partner ecosystem',/partner|ecosystem|vendor|microsoft|google|cisco|hpe|palo alto|genesys|five9|lenovo|zoom|dell|servicenow/i,
    'The ecosystem page lists selected technology companies relevant to the work. The mix of providers and specialists depends on the engagement. Their inclusion is not a claim that every provider supplies DEX or that a particular partnership is contracted.',
